...
class UsuarioServiceTest {
    ...
    @Test
    @DisplayName("CASO POSITIVO 1 - COMPLETO")
    ...
    @Test
    @DisplayName("CASO POSITIVO 1 - CAMPOS VACIOS")
    ...
    @Test
    @DisplayName("CASO NEGATIVO 1 - NOMBRE VACIO")
    ...
    @Test
    @DisplayName("CASO NEGATIVO 1 - EMAIL REPETIDO")
    ...
    @Test
    @DisplayName("CASO POSITIVO 2 - UNA ESTADISTICA")
    void consultarUsuarioEstadisticas(){
        UsuarioEstadisticaDTO estadisticas = usuarioService.obtenerUsuarioEstadisticas(1);
    ...
    @Test
    @DisplayName("CASO POSITIVO 2 - VARIAS ESTADISTICAS")
    void consultarUsuarioEstadisticasVarias(){
        UsuarioEstadisticaDTO estadisticas = usuarioService.obtenerUsuarioEstadisticas(2);
        ...
        assertEquals(1, estadisticas.getFavoritos());

        assertTrue(estadisticas.getIntercambios() >= 1);
    }

    @Test
    @DisplayName("CASO NEGATIVO 2 - NO EXISTENTE")
    ...
    @Test
    @DisplayName("CASO NEGATIVO 2 - NULL")
