...
public class ProductoServiceTest {
    ...
    @Test
    @DisplayName("CASO NEGATIVO 4 - FILTRAR CON DATOS NULOS")
    ...
    void obtenerTop5ProductosConMasIntercambiosSolo4() {
        ...
        List<CartaProductoIntercambioDTO> top5 = productoService.getTop5ProductosConMasIntercambiosActivos();
        top5.stream().forEach(System.out::println);
        assertNotNull(top5);
        assertTrue(top5.size() == 4);
    }
