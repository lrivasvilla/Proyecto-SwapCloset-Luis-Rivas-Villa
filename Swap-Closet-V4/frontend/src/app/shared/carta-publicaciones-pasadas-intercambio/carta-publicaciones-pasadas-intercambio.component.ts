...
@Component({
    selector: 'app-carta-publicaciones-pasadas-intercambio',
    templateUrl: './carta-publicaciones-pasadas-intercambio.component.html',
    styleUrls: ['./carta-publicaciones-pasadas-intercambio.component.scss'],
    standalone: true,
    imports: [
        AsyncPipe,
        IonicModule,
